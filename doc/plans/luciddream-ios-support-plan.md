...
| Field evidence                | Every device question depended on asking testers.                                                                                                                                            | Opt-in beta diagnostics for iOS and Android, dormant until switched on: [luciddream-telemetry.md](luciddream-telemetry.md).                                                                                                                                                                                                          |
