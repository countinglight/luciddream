          ...
          <>
            ...
            <ThemedView type="backgroundElement" style={styles.card}>
              ...
              <ThemedText type="small" themeColor="textSecondary">
                ...
                $short, $medium, and $long — anywhere a duration is accepted.
              </ThemedText>
              {PERIOD_PRESETS.map(({ id, label }) => (
                <PeriodPresetInput
                  ...
                  onCommit={(ms) =>
                    updateSettings({
                      periodPresets: { ...settings.periodPresets, [id]: ms },
                    })
                  }
                />
              ))}
            ...
            <ThemedView type="backgroundElement" style={styles.card}>
              ...
              <ThemedText type="small" themeColor="textSecondary">
                Duck lets alarms still cut through. Exclusive silences other
                apps&apos; audio entirely.
              </ThemedText>
            ...
            <ThemedView type="backgroundElement" style={styles.card}>
              ...
              <ThemedText type="small" themeColor="textSecondary">
                A sustained loud sound near the device pauses and lowers volume,
                then resumes on its own. It can never stop a run by itself.
              </ThemedText>
              <ThemedView style={styles.chipRow}>
                <Chip
                  label="Off"
            ...
            <ThemedView type="backgroundElement" style={styles.card}>
              ...
              <ThemedView style={styles.row}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    updateSimulatedContext({ hr: parseOptionalNumber(text) })
                  }
              ...
              <ThemedView style={styles.row}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    updateSimulatedContext({ hrv: parseOptionalNumber(text) })
                  }
                  keyboardType="numeric"
                  placeholder="unset"
                  placeholderTextColor={theme.textSecondary}
